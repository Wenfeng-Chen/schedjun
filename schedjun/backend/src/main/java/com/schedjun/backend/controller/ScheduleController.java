...
import com.schedjun.backend.common.dto.DeleteSchedulesDTO;
...
public class ScheduleController {
    ...
    @DeleteMapping
    public Result<ScheduleDeleteVO> delete(@Valid @RequestBody DeleteSchedulesDTO dto) {
        log.info("删除日程: count={}", dto.getScheduleIds().size());
        return Result.success(scheduleService.delete(dto.getScheduleIds()));
    }
